...
| `ShiftFreqRemovalAudit_298(P_minor^0)` | OPEN | Next target: classify `ShiftRemovalBudget_284(q)`, `FreqRemovalBudget_284(r)`, and their moment inputs | `module_297_e2_minor_energy_tail_audit.md` | No |
