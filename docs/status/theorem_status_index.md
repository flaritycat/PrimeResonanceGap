...
| `SignedMinorKernelCombinationVerdict_318(P_minor^0)` | OPEN | Next target: decide whether centered full-minus-major is a genuine smaller route or a restatement of the original minor row target | `module_317_major_kernel_correction_audit.md` | No |
