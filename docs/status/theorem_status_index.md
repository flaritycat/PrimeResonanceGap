...
| `PrimePartitionCoverMomentCriterion_330(P_minor^0)` | OPEN | Next target: combine Mobius degrees with partition counting and kernel weights | `module_329_prime_partition_mobius_audit.md` | No |
