...
| `FullCoverLoadCriterion_328(P_minor^0)` | OPEN | Next target: turn the cover envelope into a precise criterion and test available moments | `module_327_full_cover_cluster_audit.md` | No |
