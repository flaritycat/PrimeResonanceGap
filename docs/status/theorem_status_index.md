...
| `GenericCollisionLocalModelSplit_325(P_minor^0)` | OPEN | Next target: formulate the exact generic-versus-collision split for the eight-slot minor row | `module_324_collision_diagonal_strata_audit.md` | No |
