...
| `AdmissiblePhiGain_320 / DataDependentFiberGainAudit_321` | OPEN | Need a genuine data-dependent fiber overlap/entropy gain to produce admissible `Phi`; audit is next | `module_320_size_sensitive_minor_kernel_criterion.md` | No |
