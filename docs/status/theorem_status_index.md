...
| `AntiDiagonalNewInputInventory_319(P_minor^0)` | OPEN | Next target: inventory genuinely new non-endpoint inputs for the anti-diagonal minor-kernel row | `module_318_signed_minor_kernel_verdict.md` | No |
