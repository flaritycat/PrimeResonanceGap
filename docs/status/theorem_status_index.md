...
| `FullCoverClusterAudit_327(P_minor^0)` | OPEN | Next target: classify surviving full-cover Mobius coefficients and minimal collision/load structure | `module_326_signed_inclusion_exclusion_minor_audit.md` | No |
