...
| `MinimalTransverseFamily_278(P_minor^0)` | OPEN | Selector/model class, Fourier group, W-order, dyadic ranges, thresholds, shell convention, residue/cutoff conventions, limiting order | `module_277_tenth_plan_update_sixth_challenge.md` | No; next target only |
