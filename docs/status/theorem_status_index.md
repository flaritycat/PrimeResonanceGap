...
| `ColumnMultiplicityDistributionAudit_309(P_minor^0)` | OPEN | Next target: decide whether layer-cake/distributional formulation is genuinely smaller than the gain target | `module_308_column_barrier_moment_audit.md` | No |
