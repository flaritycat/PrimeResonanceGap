...
| `SignedInclusionExclusionMinorAudit_326(P_minor^0)` | OPEN | Next target: decide what exact signed inclusion-exclusion cancels and what remains as analytic rows | `module_325_generic_collision_local_model_split.md` | No |
