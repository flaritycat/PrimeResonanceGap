...
| `FixedSetShellTransfer_280` | OPEN | Would transfer predetermined frequency-set estimates to the data-dependent fibers `S_d(J)` and `D_xi(J)` | `module_279_xi_dual_phase_expansion.md` | No |
