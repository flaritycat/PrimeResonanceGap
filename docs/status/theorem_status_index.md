...
| `SizeSensitiveMinorKernelCriterion_320(P_minor^0)` | OPEN | Next target: formulate a size/energy/kernel criterion with losses checked against Modules 310 and 284 | `module_319_antidiagonal_new_input_inventory.md` | No |
