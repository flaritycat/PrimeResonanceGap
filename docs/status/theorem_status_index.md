...
| `MajorKernelCorrectionAudit_317(P_minor^0)` | OPEN | Next target: audit the major-kernel correction row in the centered full-minus-major formulation | `module_316_centered_full_antidiagonal_audit.md` | No |
