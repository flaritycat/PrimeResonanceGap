...
| `ExactPartitionCoarseningAudit_334(P_minor^0)` | OPEN | Next target: exact partition inequalities versus equality envelopes and coarsenings | `module_333_dyadic_residue_uniformity_audit.md` | No |
