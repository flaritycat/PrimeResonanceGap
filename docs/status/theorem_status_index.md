...
| `KernelFiberPartitionAudit_332(P_minor^0)` | OPEN | Next target: residue-mass rows for `|K_{U,V}^0(d_1,d_2;t)|` on compatibility classes | `module_331_partition_class_counting_audit.md` | No |
