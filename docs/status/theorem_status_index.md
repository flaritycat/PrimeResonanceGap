...
| `WeightedPairAutocorrelationExpansion_312(P_minor^0)` | OPEN | Next target: expand weighted pair energy through autocorrelation kernels and minor cutoff | `module_311_weighted_column_pair_energy_audit.md` | No |
